...
TrainingBinarySetInfo = importdata('./Kaggle/KaggleBinary.txt');
TrainingSetNum = length(TrainingBinarySetInfo);
% trainSet = importdata('Training_Set.txt');
% label = trainSet.data;

templateBinarySetInfo = importdata('./Kaggle/Template.txt');
...
save ./Kaggle/Kaggle-Train-Features-IDSC.mat trainFeature