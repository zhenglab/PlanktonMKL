...
datasetName = 'Kaggle';
datasetInfo = importdata('../2FeatureExtraction/KaggleExtraction/Kaggle/Kaggle.txt');
...
for i=1:length(trainingFeatures)
    ...
    [bestcSele, bestgSele] = crossValidation5(trainingFeatures{i},trainLabel,SeleParamResultName);
end
