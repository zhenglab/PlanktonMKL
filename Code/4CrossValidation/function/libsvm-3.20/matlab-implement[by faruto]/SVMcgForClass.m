function [bestacc,bestc,bestg] = SVMcgForClass(train_label,train,kernel,cmin,cmax,gmin,gmax,v,cstep,gstep,accstep)
...
for i = 1:m
    for j = 1:n
        cmd = ['-t ',num2str(kernel),' -v ',num2str(v),' -c ',num2str( basenum^X(i,j) ),' -g ',num2str( basenum^Y(i,j) )];
