...
datasetName = 'Kaggle';
trainSet = importdata('../../2FeatureExtraction/KaggleExtraction/Kaggle/Kaggle.txt');
label = trainSet.data;
...
features = {featuresTrain(:,fsfs);featuresHOGTrain(:,fsHOG);featuresGaborTrain(:,fsGabor);featuresILBP81Train(:,fsILBP81);featuresIDSCTrain(:,fsIDSC);featuresSIFTTrain100(:,fsSIFT100);featuresGranulometryTrain(:,fsGranulometry);featuresGranulometryNewTrain(:,fsGranulometryNew);featuresVariogramTrain(:,fsVariogram);featuresGLCMTrain(:,fsGLCM);featuresBGC81Train(:,fsBGC81);...
    featuresTrain(:,fsfs);featuresHOGTrain(:,fsHOG);featuresGaborTrain(:,fsGabor);featuresILBP81Train(:,fsILBP81);featuresIDSCTrain(:,fsIDSC);featuresSIFTTrain100(:,fsSIFT100);featuresGranulometryTrain(:,fsGranulometry);featuresGranulometryNewTrain(:,fsGranulometryNew);featuresVariogramTrain(:,fsVariogram);featuresGLCMTrain(:,fsGLCM);featuresBGC81Train(:,fsBGC81);...
...
ker = {{'l' 'l' 'l' 'l' 'l' 'l' 'l' 'l' 'l' 'l' 'l' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'p2' 'g4' 'g8' 'g4' 'g2' 'g4' 'g4' 'g0.5' 'g0.5' 'g0.5' 'g0.5' 'g2'}};
